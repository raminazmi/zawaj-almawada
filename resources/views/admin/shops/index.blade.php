                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-normal text-center flex justify-center gap-4">
                                            <form
                                                action="{{ route('admin.business-activities.updateStatus', $activity) }}"
                                                method="POST">
                                                @csrf
                                                <div class="relative">
                                            ...
                                            <form action="{{ route('admin.shops.destroy', $activity->id) }}"
                                                method="POST" class="inline-block delete-activity">
                                                @method('DELETE')
                                                @csrf
                                                <button type="submit"
