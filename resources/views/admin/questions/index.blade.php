...
<x-app-layout>
    <!-- الحاوية الرئيسية مع خلفية فاتحة وهامش علوي -->
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gradient-to-r from-pink-400 to-purple-500 text-white">
                                <tr>
                                    ...
                                    <th class="py-4 px-2 text-center text-md font-semibold"> سؤال الخاطب
                                    </th>
                                    <th class="py-4 px-2 text-center text-md font-semibold"> سؤال المخطوبة
                                    </th>
                                    <th class="py-4 px-2 text-center text-md font-semibold">
                                        التحكم
                                    </th>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-center space-x-2">
                                        ...
                                        <form action="{{ route('admin.questions.destroy', $question->id) }}"
                                            ...
                                            @csrf
                                            <button type="submit"
                                                class="px-4 px-4 py-1 bg-red-500 text-white rounded-md hover:bg-red-600 transition-all">
                                                حذف
                                            </button>
                                        </form>
                                    </td>
