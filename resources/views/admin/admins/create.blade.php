...
<div class="min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-2xl bg-white rounded-xl shadow-lg p-6 border border-purple-100">
        <div class="mb-6 text-center">
            ...
            <p class="text-gray-500 mt-2">املأ الحقول التالية لإضافة مشرف جديد</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="password" name="password_confirmation"
                            class="w-full px-4 py-2 border rounded-lg @error('password_confirmation') border-red-500 @else border-gray-300 @enderror focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all"
                            placeholder="••••••••">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <label
                            ...
                            <input type="radio" name="admin_role" value="main"
                                class="h-4 w-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500">
                            <span class="mr-2 text-sm text-gray-700">أدمن</span>
                        </label>
                        <label
                            class="flex items-center p-3 bg-white rounded-lg border @error('admin_role') border-red-500 @else border-gray-200 @enderror hover:border-purple-300 cursor-pointer">
                            <input type="radio" name="admin_role" value="sub"
                                class="h-4 w-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500">
