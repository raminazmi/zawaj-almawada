...
? 'inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-indigo-900 font-bold
focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
: 'inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-500
