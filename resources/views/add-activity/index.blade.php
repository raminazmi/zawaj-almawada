...
<body>
  ...
  <section class="relative">
    <div class="bg-cover bg-center py-2 lg:-mt-[109px] flex items-center justify-center min-h-screen"
        style="background-image: url('assets/images/frame.png');">
        <form id="contact-form" class="w-full max-w-md p-6 rounded-lg shadow-md mx-4">
            <input type="hidden" name="access_key" value="45f0504c-b240-4e20-9346-123057ea0b2b">
            <h2 class="text-2xl font-bold mb-4 text-center text-gray-700">اضف نشاطك</h2>
            <p id="success-message" class="text-green-600 text-center mt-4 hidden">✅ تم إرسال الرسالة بنجاح!</p>

            <div class="mb-4">
                <label for="name" class="block text-gray-600 font-medium">اسم المحل</label>
                <input type="text" id="name" name="name" required
                    class="w-full p-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-300">
            </div>

            <div class="mb-4">
                <label for="phone" class="block text-gray-600 font-medium">رقم الهاتف</label>
                <input type="number" id="phone" name="phone" required
                    class="w-full p-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-300">
            </div>

            <div class="mb-4">
                <label for="message" class="block text-gray-600 font-medium">نوع النشاط</label>
            ...
            <div class="mb-4">
                <label for="state" class="block text-gray-600 font-medium">الولاية</label>
                <textarea id="state" name="state" required rows="1"
                    class="w-full p-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-300"></textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center gap-4 mt-2">
                    <label class="flex items-center">
                        <input type="radio" name="rewards" value="yes" class="mr-2" required>
                        نعم
                    </label>
                    <label class="flex items-center">
                        <input type="radio" name="rewards" value="no" class="mr-2">
                        لا
                    </label>
                </div>
            </div>
