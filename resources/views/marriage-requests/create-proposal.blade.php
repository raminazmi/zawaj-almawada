            ...
            <form method="POST" action="{{ route('marriage-requests.store-proposal', $target->id) }}"
                ...
                <div class="space-y-6">
                    <h3 class="text-lg font-semibold text-purple-700 border-b-2 border-purple-200 pb-2">
                        <i class="fas fa-id-card text-purple-600 mr-2"></i>المعلومات الأساسية
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="relative">
                            ...
                            @error('state')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                        ...
                        <div class="relative">
                            ...
                            @error('age')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                        ...
                        <div class="relative">
                            ...
                            @error('height')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                        ...
                        <div class="relative">
                            ...
                            @error('weight')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                        ...
                        <div class="relative">
                            ...
                            @error('tribe')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                        ...
                        <div class="relative">
                            ...
                            @error('skin_color')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <select name="lineage"
                                ...
                                <option value="1">رقم (1)</option>
                                <option value="2">رقم (2)</option>
                                <option value="3">رقم (3)</option>
                            </select>
                            <i class="fas fa-project-diagram absolute left-3 top-4 text-gray-400"></i>
                            @error('lineage')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <h3 class="text-lg font-semibold text-purple-700 border-b-2 border-purple-200 pb-2">
                        <i class="fas fa-user-friends text-purple-600 mr-2"></i>الحالة الاجتماعية
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="relative">
                            ...
                            @error('marital_status')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                        ...
                        <div class="bg-purple-50 p-4 rounded-xl">
                            ...
                            <div class="flex items-center space-x-4 mb-2 gap-4">
                                <label class="flex items-center"><input type="radio" name="has_children" value="1"
                                        class="form-radio text-purple-600"><span class="mr-2">نعم</span></label>
                                <label class="flex items-center"><input type="radio" name="has_children" value="0"
                                        checked class="form-radio text-purple-600"><span class="mr-2">لا</span></label>
                            </div>
                            ...
                            <i class="fas fa-child absolute left-3 top-12 text-gray-400"></i>
                            @error('children_count')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    <h3 class="text-lg font-semibold text-purple-700 border-b-2 border-purple-200 pb-2">
                        <i class="fas fa-user-graduate text-purple-600 mr-2"></i>التعليم والعمل
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="relative">
                            ...
                            <select name="education_level"
                                ...
                                <option value="illiterate">أمي/أمية</option>
                            ...
                            @error('education_level')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <select name="work_sector"
                                ...
                                <option value="unemployed">باحث/باحثة عن عمل</option>
                            </select>
                            <i class="fas fa-briefcase absolute left-3 top-4 text-gray-400"></i>
                            @error('work_sector')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>

                        <div class="relative">
                            <label class="block text-sm font-medium text-gray-700 mb-2">المهنة/المسمى الوظيفي</label>
                            ...
                            @error('job_title')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                        ...
                        <div class="relative">
                            ...
                            @error('monthly_income')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>

                        <div class="relative">
                            <label class="block text-sm font-medium text-gray-700 mb-2">الديانة/المذهب</label>
                            <input type="text" name="religion"
                                class="w-full p-3 pl-10 rounded-lg border border-gray-200 focus:ring-2 focus:ring-purple-500 @error('religion') border-red-500 @enderror">
                            <i class="fas fa-mosque absolute left-3 top-4 text-gray-400"></i>
                            @error('religion')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>

                        @if(Auth::user()->gender === 'male')
                        <div class="relative">
                            <label class="block text-sm font-medium text-gray-700 mb-2">المنزل</label>
                            <select name="housing_type"
                                ...
                                <option value="independent">منزل مستقل</option>
                                <option value="family_annex">ملحق مع الأهل</option>
                                <option value="family_room">غرفة ببيت الأهل</option>
                            </select>
                            <i class="fas fa-door-open absolute left-3 top-4 text-gray-400"></i>
                            @error('housing_type')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                        @else
                        <div class="relative">
                            <label class="block text-sm font-medium text-gray-700 mb-2">المنزل المطلوب عند
                                الزواج</label>
                            <select name="housing_type"
                                class="w-full p-3 pl-10 pr-8 rounded-lg border border-gray-200 focus:ring-2 focus:ring-purple-500 @error('housing_type') border-red-500 @enderror">
                                <option value="independent">منزل مستقل</option>
                                <option value="family_annex">ملحق مع الأهل</option>
                                <option value="family_room">غرفة ببيت الأهل</option>
                                <option value="no_preference">لا يهم</option>
                            </select>
                            <i class="fas fa-door-open absolute left-3 top-4 text-gray-400"></i>
                            @error('housing_type')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                ...
                <div class="space-y-6">
                    <h3 class="text-lg font-semibold text-purple-700 border-b-2 border-purple-200 pb-2">
                        <i class="fas fa-medkit text-purple-600 mr-2"></i>المعلومات الصحية
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="relative">
                            ...
                            <textarea name="genetic_diseases" rows="2"
                                class="w-full p-3 pl-10 rounded-lg border border-gray-200 focus:ring-2 focus:ring-purple-500 @error('genetic_diseases') border-red-500 @enderror"
                                placeholder="لا توجد، حامل/حاملة فقط، مصاب/مصابة"></textarea>
                            <i class="fas fa-dna absolute left-3 top-4 text-gray-400"></i>
                            @error('genetic_diseases')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <textarea name="infectious_diseases" rows="2"
                                class="w-full p-3 pl-10 rounded-lg border border-gray-200 focus:ring-2 focus:ring-purple-500 @error('infectious_diseases') border-red-500 @enderror"
                                placeholder="لا توجد، توجد وهي..."></textarea>
                            <i class="fas fa-biohazard absolute left-3 top-4 text-gray-400"></i>
                            @error('infectious_diseases')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <textarea name="psychological_disorders" rows="2"
                                class="w-full p-3 pl-10 rounded-lg border border-gray-200 focus:ring-2 focus:ring-purple-500 @error('psychological_disorders') border-red-500 @enderror"
                                placeholder="لا توجد، توجد وهي..."></textarea>
                            <i class="fas fa-head-side-virus absolute left-3 top-4 text-gray-400"></i>
                            @error('psychological_disorders')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>

                        <div class="relative">
                            <label class="block text-sm font-medium text-gray-700 mb-2">الحالة الصحية</label>
                            <textarea name="health_status" rows="2"
                                ...
                                placeholder="لا أعاني من أي أمراض، لدي أمراض وهي..."></textarea>
                            <i class="fas fa-comment-medical absolute left-3 top-4 text-gray-400"></i>
                            @error('health_status')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                        ...
                        <div class="bg-purple-50 p-4 rounded-xl">
                            ...
                            <div class="flex items-center space-x-4 mb-2 gap-4">
                                <label class="flex items-center"><input type="radio" name="has_disability" value="1"
                                        class="form-radio text-purple-600"><span class="mr-2">نعم</span></label>
                                <label class="flex items-center"><input type="radio" name="has_disability" value="0"
                                        checked class="form-radio text-purple-600"><span class="mr-2">لا</span></label>
                            </div>
                            ...
                            <i class="fas fa-info-circle absolute left-3 top-12 text-gray-400"></i>
                            @error('disability_details')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>

                        <div class="bg-purple-50 p-4 rounded-xl">
                            <label class="block text-sm font-medium text-purple-600 mb-2">هل لديك تشوهات؟</label>
                            <div class="flex items-center space-x-4 mb-2 gap-4">
                                <label class="flex items-center"><input type="radio" name="has_deformity" value="1"
                                        class="form-radio text-purple-600"><span class="mr-2">نعم</span></label>
                                <label class="flex items-center"><input type="radio" name="has_deformity" value="0"
                                        checked class="form-radio text-purple-600"><span class="mr-2">لا</span></label>
                            </div>
                            ...
                            <i class="fas fa-exclamation-triangle absolute left-3 top-12 text-gray-400"></i>
                            @error('deformity_details')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>

                        <div class="bg-purple-50 p-4 rounded-xl">
                            <label class="block text-sm font-medium text-purple-600 mb-2">هل ترغب/ترغبين في
                                الإنجاب؟</label>
                            <div class="flex items-center space-x-4 gap-4">
                                <label class="flex items-center"><input type="radio" name="wants_children" value="1"
                                        class="form-radio text-purple-600"><span class="mr-2">نعم</span></label>
                                <label class="flex items-center"><input type="radio" name="wants_children" value="0"
                                        checked class="form-radio text-purple-600"><span class="mr-2">لا</span></label>
                            </div>
                        </div>

                        <div class="bg-purple-50 p-4 rounded-xl">
                            <label class="block text-sm font-medium text-purple-600 mb-2">هل لديك عقم؟</label>
                            <div class="flex items-center space-x-4 gap-4">
                                <label class="flex items-center"><input type="radio" name="infertility" value="1"
                                        class="form-radio text-purple-600"><span class="mr-2">نعم</span></label>
                                <label class="flex items-center"><input type="radio" name="infertility" value="0"
                                        checked class="form-radio text-purple-600"><span class="mr-2">لا</span></label>
                            </div>
                        </div>
                        ...
                        @if(Auth::user()->gender === 'male')
                        <div class="bg-purple-50 p-4 rounded-xl">
                            <label class="block text-sm font-medium text-purple-600 mb-2">هل أنت مدخن؟</label>
                            <div class="flex items-center space-x-4 gap-4">
                                <label class="flex items-center"><input type="radio" name="is_smoker" value="1"
                                        class="form-radio text-purple-600"><span class="mr-2">نعم</span></label>
                                <label class="flex items-center"><input type="radio" name="is_smoker" value="0" checked
                                        class="form-radio text-purple-600"><span class="mr-2">لا</span></label>
                            </div>
                        </div>
                        @endif
                    </div>
                ...
                <div class="space-y-6">
                    <h3 class="text-lg font-semibold text-purple-700 border-b-2 border-purple-200 pb-2">
                        <i class="fas fa-comment-dots text-purple-600 mr-2"></i>معلومات إضافية
                    </h3>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="relative">
                            <label class="block text-sm font-medium text-gray-700 mb-2">درجة التدين</label>
                            <select name="religiosity_level"
                            ...
                            @error('religiosity_level')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>

                        <div class="relative">
                            <label class="block text-sm font-medium text-gray-700 mb-2">ملتزم/ملتزمة بأداء الصلاة
                                والصيام</label>
                            <select name="prayer_commitment"
                                ...
                                <option value="sometimes">إلى حد ما</option>
                                <option value="no">لا</option>
                            </select>
                            <i class="fas fa-clock absolute left-3 top-4 text-gray-400"></i>
                            @error('prayer_commitment')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>

                        <div class="md:col-span-2 relative">
                            <label class="block text-sm font-medium text-gray-700 mb-2">وصف شخصي</label>
                            <textarea name="personal_description" rows="4"
                                class="w-full p-3 pl-10 rounded-lg border border-gray-200 focus:ring-2 focus:ring-purple-500 @error('personal_description') border-red-500 @enderror"
                                placeholder="هواياتك، اهتماماتك، مهاراتك، صفاتك، طباعك، عاداتك، ما يضايقك، طموحك، أهدافك من الزواج، كيف تصف/تصفين نفسك"></textarea>
                            <i class="fas fa-pen absolute left-3 top-4 text-gray-400"></i>
                            @error('personal_description')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>

                        <div class="md:col-span-2 relative">
                            <label class="block text-sm font-medium text-gray-700 mb-2">مواصفات الشريك المطلوب</label>
                            <textarea name="partner_expectations" rows="4"
                                class="w-full p-3 pl-10 rounded-lg border border-gray-200 focus:ring-2 focus:ring-purple-500 @error('partner_expectations') border-red-500 @enderror"
                                placeholder="@if(Auth::user()->gender === 'male')العمر، المنطقة، وضعها الاجتماعي، اللبس، مواصفات الجمال، درجة تدينها، مستواها التعليمي، تعمل أو لا، مكان عملها، الفكر والتوجه، الصفات المرغوبة وغير المرغوبة، ما يمنع الارتباط@elseالعمر، المنطقة، وضعه الاجتماعي، المظهر الخارجي، مواصفات الجمال، درجة تدينه، مستواه التعليمي، يعمل أو لا، مكان عمله، الفكر والتوجه، الصفات المرغوبة وغير المرغوبة، ما يمنع الارتباط@endif"></textarea>
                            <i class="fas fa-search absolute left-3 top-4 text-gray-400"></i>
                            @error('partner_expectations')<div class="mt-1 text-red-600 text-sm flex items-center"><i
                                    class="fas fa-exclamation-circle ml-1"></i>{{ $message }}</div>@enderror
                        </div>
                    </div>
                </div>
