...
<body>
  ...
  <h2 class="text-3xl font-bold mb-4 text-center text-purple-800 border-b-[3px] pb-3 border-[#d4b341]">برنامج الزواج الشرعي</h2>
<div class="flex justify-between items-center mt-8 gap-16">
    <div class="flex justify-center items-center flex-col bg-white w-[250px] p-4 border-2 border-[#d4b341] rounded-2xl transition duration-300 ease-in-out transform hover:scale-105 shadow-xl cursor-pointer">
  ...
  <footer class="bg-purple-900 text-white pt-6  ">
