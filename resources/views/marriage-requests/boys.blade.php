            ...
            <div
                ...
                <div class="p-6">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800 mb-1">{{ $boy->name }}</h3>
                            <p class="text-sm text-gray-600">{{ $boy->age }} سنة</p>
                            <p class="text-sm text-gray-600"> {{ $boy->skin_color }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between items-center mt-4">
                        <span @class([ 'px-3 py-1 rounded-full text-sm' , 'bg-green-100 text-green-800'=> $boy->status
                            ...
                            {{ $boy->status === 'available' ? 'متاح' : 'غير متاح' }}
                        </span>
