            ...
            <div class="hidden lg:flex items-center space-x-6 ">
                ...
                <div class="relative" x-data="{ isOpen: false }" @click.away="isOpen = false">
                    ...
                    <div x-show="isOpen" x-cloak
                        ...
                        <a href="#"
                            class="block px-4 py-2 text-sm hover:bg-pink-50 {{ request()->routeIs('compatibility') ? 'text-purple-700' : 'text-gray-900' }}">
    ...
    <div x-show="open" class="lg:hidden px-4 pb-4 space-y-2" x-cloak>
        ...
        <div x-data="{ isOpen: false }">
            ...
            <div x-show="isOpen" x-cloak class="pl-4 space-y-2">
                <a href="#" class="block text-sm hover:bg-pink-50 py-2 px-1">مقياس التوافق الزواجي</a>
                <a href="#" class="block text-sm hover:bg-pink-50 py-2 px-1">اختبار الجاهزية للحياة الزوجية</a>
            </div>
        </div>
