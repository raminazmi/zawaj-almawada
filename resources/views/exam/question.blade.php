...
<div class="p-6">
    <div class="bg-purple-50 p-4 rounded-xl border border-purple-200 my-6">
        ...
        <ul class="list-disc list-inside text-sm text-purple-700 space-y-2">
            <li>
                إذا كنت تعتبر السؤال ذو أهمية قصوى <strong class="text-red-500">(خط أحمر)</strong> في قبول أو رفض
                الزواج بالطرف الآخر فضع المؤشر على أنها حاسمة قبل أن تجيب بنعم أو لا.
            </li>
            <li>
