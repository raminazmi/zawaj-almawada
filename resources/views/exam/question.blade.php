...
<div class="p-6">
    <div class="bg-purple-50 p-4 rounded-xl border border-purple-200 my-6">
        <div class="flex items-center mb-2">
            ...
            <h4 class="font-semibold text-purple-900">تعليمات الأسئلة الحاسمة</h4>
        </div>
        <ul class="list-disc list-inside text-sm text-purple-700 space-y-2">
            <li>الأسئلة الحاسمة هي الأسئلة التي تعتبرها <strong>مهمة جدًا</strong> في تحديد التوافق.</li>
            <li>قم بتفعيل مربع الاختيار أعلى السؤال إذا كان <strong>أمراً مهمًا</strong> بالنسبة لك.</li>
            <li>اختر "نعم" أو "لا" بناءً على رأيك الشخصي لكل سؤال.</li>
            <li>كلما زاد عدد الأسئلة الحاسمة، زادت دقة النتائج.</li>
        </ul>
    </div>
</div>
@else
