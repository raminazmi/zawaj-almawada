...
<div class="min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        @if ($token)
        <!-- Pledge Section (Shown only when token exists, hidden after exam starts) -->
        <div id="pledge_section" class="bg-white rounded-3xl shadow-2xl border border-purple-100 overflow-hidden">
            <div class="p-8">
    ...
    <!-- Instructions Modal (Only shown when token exists) -->
    ...
    <!-- Video Modal (Only shown when token exists) -->
