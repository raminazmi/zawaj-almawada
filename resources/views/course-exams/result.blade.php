...
<div class="bg-gray-100">
            ...
            <div class="bg-white shadow-2xl rounded-3xl p-2 sm:p-4 border border-[#3A8BCD]/20">
                <div
                    ...
                    <div
                        ...
                        <p class="text-center mt-1 sm:mt-2 text-gray-600"> شهادة معتمدة من منصة زواج المودة<br>
                            للاستشارات الزوجية والأسرية </p>
                        <div class="mt-2 sm:mt-0">
                            <p class="text-center"><strong>مع تحيات مدير منصة زواج المودة</strong></p><br>
                            <div class="text-center"> <img src="{{ asset('assets/images/signature.jpg') }}"
                                    alt="توقيع المدير" class="max-w-[120px] sm:max-w-[150px] mx-auto block"> </div>
                        </div>
                    </div>
                </div>
                <div class="mt-4 sm:mt-8 flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-4"> <a
                        href="{{ route('course-exams.index') }}"
                        ...
                        <i class="fas fa-arrow-right ml-1 sm:ml-2"></i> العودة للاختبارات </a> <a
                        href="{{ route('course-exams.certificate.download', $result->id) }}" id="downloadButton"
                        ...
                        <i class="fas fa-download ml-1 sm:ml-2"></i> تحميل الشهادة </a> </div>
            </div>
        </div>
    </div>
    <style>
    ...
    <script>
        document.getElementById('downloadButton').addEventListener('click', function() { var button = this; button.innerText = 'جاري تحميل الشهادة...'; button.classList.remove('bg-gradient-to-r', 'from-blue-500', 'to-blue-600', 'text-white', 'hover:opacity-90'); button.classList.add('bg-gray-600', 'text-gray-100', 'opacity-50'); }); 
    </script>
</div>
@endsection